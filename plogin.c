...
int Draw_Plogin()
{
	...
	setfillstyle(1,WHITE);                       //画乘客登录标准
	setlinestyle(SOLID_LINE,0,NORM_WIDTH);
	setcolor(LIGHTGRAY);
	circle(320,200-70,50);
	setcolor(WHITE);
	circle(320,200-70,75);
	floodfill(315,205-70,LIGHTGRAY);
	setfillstyle(1,BLUE);
	pieslice(320,195-70,0,229,25);
	pieslice(320,195-70,311,360,25);
	setfillstyle(1,WHITE);
	pieslice(320,195-70,0,229,18);
	pieslice(320,195-70,311,360,18);
	setcolor(BLUE);
	setlinestyle(SOLID_LINE,0,NORM_WIDTH);
	line(338,195-70,345,195-70);
	setlinestyle(SOLID_LINE,0,THICK_WIDTH);
	line(300,220-70,318,215-70);
	line(340,220-70,322,215-70);
	setfillstyle(1,BLUE);
	bar(310,195-70,330,203-70);
	bar(318,203-70,322,220-70);
	bar(300,220-70,340,224-70);
	bar(330,217-70,317,223-70);
	bar(310,217-70,323,223-70);
	bar(315,168-70,325,173-70);
	setcolor(DARKGRAY);
	circle(320,200-70,75);
	setcolor(DARKGRAY);	
	setlinestyle(SOLID_LINE,0,THICK_WIDTH);
