...
void  Draw_Login()
{
	...
	bar(0,0,640,60);
	bar(0,440,640,480);
	puthz(240,14,"嶠볶뻑있믄",32,32,LIGHTGRAY);
	
	puthz(95,203,"瑯뵀",32,32,CYAN);
	puthz(95,245,"쵱쯤",32,32,CYAN);
	...
	setfillstyle(1, RED);
    bar(260,290,380,325);
    puthz(291,295,"되쩌",24,34,WHITE);

    setfillstyle(1,WHITE);
    bar(136,340,200,365);
    puthz(148,344,"鬧꿍",16,24,LIGHTBLUE);
    setlinestyle(0,0,1);
    setcolor(LIGHTBLUE);
    rectangle(136,340,200,365);
    
    bar(264,340,376,365);
    puthz(276,344,"戈션쵱쯤",16,24,LIGHTBLUE);
    rectangle(264,340,376,365);
    
    bar(440,340,504,365);
    puthz(452,344,"藁놔",16,24,LIGHTBLUE);
    rectangle(440,340,504,365);
    
    setfillstyle(1,RED);
	bar(460,297,540,317);
	puthz(468,299,"踏와되쩌",16,16,WHITE);
} 
...
int Judge_Login(char *a,char *p,int *n)
{
	...
	for(i=0;i<l;i++)
	{
		...
		{         
			...
			{
				puthz(550,250,"쵱쯤댄轎",16,16,RED);
				break;
			}
			else if(strcmp(p,temp->password)==0)
			{   *n=temp->num;
				puthz(550,250,"쵱쯤攣횅",16,16,RED);
				if(temp!=NULL)
				{
					free(temp);
					temp=NULL;
