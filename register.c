	...
	while(1)
	{
		...
		/*if (MouseX > 175 && MouseX < 545 && MouseY>325 && MouseY < 350)
		{
			...
			if (mouse_press(175, 325, 545, 350) == 2)            //未点击验证码输入框
			{
				if (flag == 0 && pos5 == 0)
				{
					Register_Lighten(175, 325, 545, 350,8);
					flag = 8;
				}
				continue;
			}
			...
			else if (mouse_press(175, 325, 545, 350) == 1)
			{
				...
				MouseS = 0;
				VC[0] = '\0';
				Input_Vis(VC, 175, 325, 6, LIGHTGRAY);
				R_Code_Jundge(str,VC);
				if(strlen(VC) != 0)
					pos5=1;
				else 
					pos5=0;
...
int Draw_Register(char* str)
{
	...
	//puthz(95,300,"请输入验证码",16,16,CYAN);
